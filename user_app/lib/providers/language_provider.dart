...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, String> _englishStrings = {
    ...
    'enter_name_hint': 'Full Name is required',
    'enter_mobile': 'Enter mobile number',
    'enter_mobile_hint': 'Enter mobile number',
    'valid_mobile': 'Valid 10-digit number required',
    'send_otp': 'Send OTP',
    'already_have_account': 'Already have an account? ',
    'login': 'Login',

    // Onboarding
    'personalize_subtitle': 'Help us personalize your experience',
  ...
  static const Map<String, String> _tamilStrings = {
    ...
    'failed_to_update': 'சுயவிவரத்தை புதுப்பிக்க முடியவில்லை',
    'required_field': 'கட்டாயமானது',
    'enter_valid_email': 'சரியான மின்னஞ்சல் உள்ளிடவும்',
    'create_account': 'கணக்கு உருவாக்கு',
    'register_subtitle': 'தொடங்க பதிவு செய்யவும்',
    'enter_name': 'உங்கள் பெயர் உள்ளிடவும்',
    'enter_name_hint': 'முழு பெயர் தேவை',
    'enter_mobile': 'மொபைல் எண் உள்ளிடவும்',
    'enter_mobile_hint': 'மொபைல் எண் உள்ளிடவும்',
    'valid_mobile': 'சரியான 10 இலக்க எண் தேவை',
    'send_otp': 'OTP அனுப்பு',
    'already_have_account': 'ஏற்கனவே கணக்கு உள்ளதா? ',
    'login': 'உள்நுழைக',
    'personalize_subtitle': 'உங்கள் அனுபவத்தை தனிப்பயனாக்க உதவுங்கள்',
    'email_optional': 'மின்னஞ்சல் முகவரி (விரும்பினால்)',
    'full_name_required': 'முழு பெயர் *',
  ...
  static const Map<String, String> _hindiStrings = {
    ...
    'register_subtitle': 'शुरू करने के लिए पंजीकृत हों',
    'enter_name': 'अपना नाम दर्ज करें',
    'enter_name_hint': 'पूरा नाम आवश्यक है',
    'enter_mobile': 'मोबाइल नंबर दर्ज करें',
    'enter_mobile_hint': 'मोबाइल नंबर दर्ज करें',
    'valid_mobile': 'वैध 10-अंकीय नंबर आवश्यक है',
    'send_otp': 'OTP भेजें',
    'already_have_account': 'पहले से खाता है? ',
    'login': 'लॉगिन',
    'personalize_subtitle': 'अपना अनुभव व्यक्तिगत बनाएं',
  ...
  static const Map<String, String> _malayalamStrings = {
    ...
    'failed_to_update': 'പ്രൊഫൈൽ അപ്‌ഡേറ്റ് ചെയ്യാൻ പറ്റിയില്ല',
    'required_field': 'ആവശ്യമാണ്',
    'enter_valid_email': 'ശരിയായ ഇ-മെയിൽ നൽകൂ',
    'create_account': 'അക്കൗണ്ട് ഉണ്ടാക്കുക',
    'register_subtitle': 'ആരംഭിക്കാൻ ഇവിടെ രജിസ്ട്രർ ചെയ്യൂ',
    'enter_name': 'നിങ്ങളുടെ പേര് നൽകൂ',
    'enter_name_hint': 'പൂർണ്ണ നാമം ആവശ്യമാണ്',
    'enter_mobile': 'മൊബൈൽ നമ്പർ നൽകൂ',
    'enter_mobile_hint': 'മൊബൈൽ നമ്പർ നൽകൂ',
    'valid_mobile': '10 അക്ക നമ്പർ ആവശ്യമാണ്',
    'send_otp': 'OTP അയക്കുക',
    'already_have_account': 'ഇതിനകം ഒരു അക്കൗണ്ട് ഉണ്ടോ? ',
    'login': 'ലോഗിൻ',
    'personalize_subtitle': 'നിങ്ങളുടെ അനുഭവം വ്യക്തിഗതമാക്കാൻ സഹായിക്കൂ',
    'email_optional': 'ഇ-മെയിൽ വിലാസം (ഐച്ഛികം)',
    'full_name_required': 'പൂർണ്ണ നാമം *',
  ...
  static const Map<String, String> _kannadaStrings = {
    ...
    'profile_updated': 'ಪ್ರೊಫೈಲ್ ಯಶಸ್ವಿಯಾಗಿ ಅಪ್‌ಡೇಟ್ ಆಯಿತು',
    'failed_to_update': 'ಪ್ರೊಫೈಲ್ ಅಪ್‌ಡೇಟ್ ವಿಫಲವಾಗಿದೆ',
    'required_field': 'ಅಗತ್ಯವಿದೆ',
    'enter_valid_email': 'ಮಾನ್ಯ ಇಮೇಲ್ ನಮೂದಿಸಿ',
    'create_account': 'ಖಾತೆ ರಚಿಸಿ',
    'register_subtitle': 'ಪ್ರಾರಂಭಿಸಲು ನೋಂದಾಯಿಸಿ',
    'enter_name': 'ನಿಮ್ಮ ಹೆಸರು ನಮೂದಿಸಿ',
    'enter_name_hint': 'ಪೂರ್ಣ ಹೆಸರು ಅಗತ್ಯ',
    'enter_mobile': 'ಮೊಬೈಲ್ ನಂಬರ್ ನಮೂದಿಸಿ',
    'enter_mobile_hint': 'ಮೊಬೈಲ್ ನಂಬರ್ ನಮೂದಿಸಿ',
    'valid_mobile': '10 ಅಂಕಿಯ ನಂಬರ್ ಅಗತ್ಯ',
    'send_otp': 'OTP ಕಳುಹಿಸಿ',
    'already_have_account': 'ಈಗಾಗಲೇ ಖಾತೆ ಇದೆಯೇ? ',
    'login': 'ಲಾಗಿನ್',
    'personalize_subtitle': 'ನಿಮ್ಮ ಅನುಭವವನ್ನು ವ್ಯಕ್ತಿಗತಗೊಳಿಸಲು ಸಹಾಯ ಮಾಡಿ',
    'email_optional': 'ಇಮೇಲ್ ವಿಳಾಸ (ಐಚ್ಛಿಕ)',
    'full_name_required': 'ಪೂರ್ಣ ಹೆಸರು *',
